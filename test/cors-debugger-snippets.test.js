...
test('diagnosis is prevented while JSON is invalid', () => {
  ...
  assert.equal(elements.diagnosticStatus.classes.has('status'), true);
  assert.equal(elements.diagnosticStatus.classes.has('bad'), true);
...
test('valid JSON works and correcting invalid JSON clears validation', () => {
  ...
  assert.equal(elements.diagnosticStatus.classes.has('status'), false);
  assert.equal(elements.diagnosticStatus.classes.has('bad'), false);
